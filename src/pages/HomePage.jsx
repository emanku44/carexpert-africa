...
export default function HomePage({ user }) {
  ...
  const filtersActive = make || model || body || transmission || fuel || minPrice > 0 || maxPrice < 30000000 || minYear > 1 || maxYear < 2025 || minKm > 0 || maxKm < 300000
              ...
              {featured.map(car => (
                <div key={car.id} style={{ background:'white', borderRadius:12, overflow:'hidden', boxShadow:'0 4px 20px rgba(21,101,192,0.15)', border:'2px solid #1565C0', position:'relative' }}>
                  ...
                  <div style={{ padding:14 }}>
                    <h3 style={{ margin:'0 0 4px', fontSize:15, fontWeight:700, color:'#0A2540' }}>{car.year} {car.make} {car.model}{car.variant ? ` — ${car.variant}` : ''}</h3>
