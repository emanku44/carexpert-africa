          ...
          <div style={{ width:'100%', maxWidth:360 }}>
            {tab === 'login' ? (
              <>
                ...
                <button onClick={handleGoogleLogin} style={{ width:'100%', background:'#fff', color:'#0A2540', border:'1.5px solid #E2E8F0', padding:13, borderRadius:9, fontSize:14, fontWeight:600, cursor:'pointer', fontFamily:'DM Sans,sans-serif', display:'flex', alignItems:'center', justifyContent:'center', gap:10 }}>
